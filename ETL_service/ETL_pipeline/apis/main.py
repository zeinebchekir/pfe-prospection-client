...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        # Browser dev servers (Vite)
        "http://localhost:5173", "http://localhost:5174",
        "http://localhost:5175",
        "http://127.0.0.1:5173", "http://127.0.0.1:5174",
        # Android emulator → host machine (Capacitor native)
        "http://10.0.2.2",
        "http://10.0.2.2:5173",
        "http://10.0.2.2:8080",
    ],
...
app.include_router(etl_status_router)     # GET /etl/status | POST /etl/trigger-initial-load
...
etl_run_fail   = Counter('etl_run_failed_total',   'Failed runs',         ['dag_id'])
